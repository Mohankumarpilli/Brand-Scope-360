  ...
  return (
    <motion.header
      ...
      className={`fixed w-full top-0 z-50 transition-all duration-300 ${
        isScrolled ? 'bg-black/95 backdrop-blur-lg border-b border-brand-red/20' : 'bg-transparent'
      }`}
    >
          ...
          >
            <nav className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col space-y-3 pt-4">
                <button className="px-6 py-2.5 text-brand-red border border-brand-red hover:bg-brand-red hover:text-white transition-all rounded-lg">
                  Login
                </button>
